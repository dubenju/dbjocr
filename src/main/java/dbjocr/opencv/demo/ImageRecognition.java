...
public class ImageRecognition {
    ...
    public void matchImage(Mat templateImage, Mat originalImage) {
        ...
        if (matchesPointCount >= 4) {
            ...
            Highgui.imwrite("./output/原图中的匹配图.jpg", subMat);
            ...
            Highgui.imwrite("./output/特征点匹配过程.jpg", matchOutput);
            Highgui.imwrite("./output/模板图在原图中的位置.jpg", originalImage);
        } else {
            System.out.println("模板图不在原图中！");
        }

        Highgui.imwrite("./output/模板特征点.jpg", outputImage);
    }

    public static void main(String[] args) {
        System.loadLibrary(Core.NATIVE_LIBRARY_NAME);

        String templateFilePath = "./input/模板.jpeg";
        String originalFilePath = "./input/原图.jpeg";
        //读取图片文件
